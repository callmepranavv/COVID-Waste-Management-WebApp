...
<body>
		...
		<h1 id="text">Fill your Details</h1>	
		<div id="d1">
       ...
       <button id="dark" onclick="myFunction()"></button>
	    ...
	    <form class="myform" action="" method="post">
			...
			<label style="color:#182C61"><b>Quantity:</b></label><br>
			<input name="quantity" type="text" class="inputvalues" placeholder="Enter Quantity" required/><br>
			<label style="color:#182C61"><b>Zipcode:</b></label><br>
			<input name="pincode" type="text" class="inputvalues" placeholder="Enter your Zipcode" required/><br>
			<label style="color:#182C61"><b>Address:</b></label><br>
			<input name="address" type="text" class="inputvalues" placeholder="Enter your Full Address" required/><br>
			<label style="color:#182C61"><b>Pick-up Date:</b></label><br>
			<input name="date" type="date" class="inputvalues" placeholder="Enter Pick-up date" required/><br>
			<label style="color:#182C61"><b>E-mail:</b></label><br>
			<input name="email" type="email" class="inputvalues" placeholder="Enter your email" required/><br>
			<label style="color:#182C61"><b>Pin:</b></label><br>
	...
	<div id="d3">
		<h3 style="color:white" >@copyright-content</h3>
	</div>
	<script>
function myFunction() {
