...
<body>
       ...
       <button id="dark" onclick="myFunction()"></button>
	    ...
	    <form class="myform" action="" method="post">
			...
			<label ><b><b><img id = "p2" src="imgs2/cart.webp"  height="22" width="22">  Approx Sq ft:</b></label><br>
			...
			<label ><b><b><img id = "p2" src="imgs2/date.webp"  height="22" width="22">  Choose Date:</b></label><br>
		...
		<?php
			if(isset($_POST['submit_btn']))
			{
				...
				$query= "insert into data1 values('','$fullname','$gender','$phnumber','$aphnumber','$type','$quantity','$pincode','$address','$date','$email','$pin')";
